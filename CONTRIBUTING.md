...
- Create an [issue](https://github.com/acrool/acrool-react-fetcher/issues) on GitHub, if you have found a bug
...
- Submit an [issue](https://github.com/acrool/acrool-react-fetcher/issues), assuming one does not already exist.
